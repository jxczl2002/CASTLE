...
def generate_conditions():
    input_dir = '3D_3_xy_test/xy'
    output_dir = '3D_3_xy_test/condition'
    ...
    x = np.linspace(-0.1 + 0.2/256/2, 0.1 - 0.2/256/2, nx)
    y = np.linspace(-0.1 + 0.2/256/2, 0.1 - 0.2/256/2, ny)
    ...
    mask_int_xy = (np.abs(X) <= 0.09) & (np.abs(Y) <= 0.09)
