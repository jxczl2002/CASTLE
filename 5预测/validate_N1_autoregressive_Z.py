...
NUM_LAYERS = 2                            
DIR_A1 = f'3D_{NUM_LAYERS}_test/condition' 
DIR_B1 = f'3D_{NUM_LAYERS}_test/temp'       

AE_MODEL_DIR = 'Models_Autoencoders_Final'
MPNN_MODEL_PATH = f'Models_Flux_Specialized_Flux_Training_Data_Final_3D_{NUM_LAYERS}/best_transfer_mpnn.pth' 
OUTPUT_DIR = f'Validation_Results_N1_{NUM_LAYERS}L_StartT1_Transfer_Z'
